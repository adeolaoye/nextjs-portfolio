...
I am a Software Engineer with dedication and commitment to learning. I am growing fast and at a geometric rate.
Formerly an investment banker and currently a Real Estate developer. I ventured into web development as an act of passion for tech and website development and since then I have found it quite interesting as two days are never the same.</p>
<p className='bio-para'>I studied different programming languages at the University of Birmingham following my earlier degrees in Banking & Finance. It is worthy to mention that I found Web Engineering so empowering. I am now working as a Software developer with skills in FrontEnd Development. I have skills in HTML, CSS, JavaScript, jQuery, Bootstraps, Node.js, Reacts and many more and these has equipped me to work and deliver on a variety of development projects.</p>
...
<p className='bio-para'>I work remotely as a freelancer in FrontEnd Development but could also take on permanent or consulting role in your establishment with a view to making your system/website more vibrant, agile and dynamic to meet your clients or customers need and by extension your profit and social responsibility goals
